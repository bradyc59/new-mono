...
class GameView {
    ...
    initComponents() {
        ...
        this.roomCode = document.getElementById("room_code").value;
    ...
    initWebSocket() {
        const ConnectionString = 'ws://' + window.location.host + '/ws/play/' + this.roomCode + '/';
        this.gameSocket = new WebSocket(ConnectionString)
